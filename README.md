...
> Wanted a fun interactive way for people to browse my Github.
> Fully generated by AI. I have no idea of anything thats happening inside.
> I have noticed the performance issues. Will try to optimize these manually at some point when I have the time.
> If anyone wants to use this as a template feel free to.
